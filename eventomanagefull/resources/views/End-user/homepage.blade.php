...
<div id="demo" class="carousel slide" data-ride="carousel" style="margin-top:3%">
  ...
  <div class="container">
    ...
    <div style="margin-top:5%">
      <p class="text">We as a eventOmanage provide them all possible solution for organizing and managing their event at single click at single place without any kind of burden at all.</p>
    </div>
