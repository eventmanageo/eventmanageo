    ...
    <div class="col-sm">
      <div class="card" style="width: 20rem;">
          ...
          <div class="card-body">
            ...
            <input type="text" name="photographer" value="photographer" hidden/>
            <input type="text" name="photographer_id" value="{{ $data -> id }}" hidden/>
            <input type="text" name="photographer_name" value="{{ $data -> item_name }}" hidden/>
