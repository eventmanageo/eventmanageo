        ...
        @foreach ($serviceBunch as $service)
            <div class="item  col-xs-4 col-lg-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h4 class="group inner list-group-item-heading">{{$service->item_name}}</h4>
                        <p class="group inner list-group-item-text">{{$service->item_description}} | {{$service->item_category}} | {{$service->dine_name}}</p>
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <p class="lead"><i class="fas fa-rupee-sign"></i> {{$service->item_price}}</p>
                            </div>
                            <script>
