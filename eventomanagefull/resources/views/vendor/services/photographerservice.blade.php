            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="item_name" name="item_name" @if(isset($edit)) value="{{$serviceData[0]->item_name}}" required @else required @endif />
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-3 text-left col-form-label">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6 text-left">
                            <input class="form-control" type="text" id="item_price" name="item_price" @if(isset($edit)) value="{{$serviceData[0]->item_price}}" required @else required @endif />
                        </div>
                    </div>
                    <div class="row form-group">
