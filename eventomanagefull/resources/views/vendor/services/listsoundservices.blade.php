        ...
        @foreach ($serviceBunch as $service)
            <div class="item  col-xs-4 col-lg-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h4 class="group inner list-group-item-heading">{{$service->service_name}}</h4>
                        <p class="group inner list-group-item-text">{{$service->service_description}} | {{$service->service_type}}</p>
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <p class="lead"><i class="fas fa-rupee-sign"></i> {{$service->service_price}}</p>
                            </div>
                            <script>
